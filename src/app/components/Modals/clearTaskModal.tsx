...
interface ClearAllTasksModalProps {
  isOpen: boolean;
  onClose: () => void;
  onClearAll: () => void;
}

const ClearAllTasksModal: React.FC<ClearAllTasksModalProps> = ({ isOpen, onClose, onClearAll }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <h2 className="text-2xl font-bold text-[#1E2C71] mb-4 text-center">Clear All Tasks</h2>
